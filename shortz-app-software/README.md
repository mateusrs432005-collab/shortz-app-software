...
# Shortz-App 🔗
> Aplicação de encurtamento de URLs desenvolvida para a disciplina de Testes de
Software
## 📋 Sobre o Projeto
Shortz-App é uma aplicação web que permite encurtar URLs longas, facilitando o
compartilhamento. Este projeto foca em boas práticas de testes de software.
...
│ ├── videos/
│ └── covers/
├── routes/ (controladores de rotas da aplicação)
│ ├── index.js
│ └── users.js
